...
with open('MAE_error_data_4_CNN_with_STL_Decomposition_in48.csv', 'w') as f:
    for key, value in dict2data.items():
        f.write('%s:%s\n' % (key, value))
with open('MAPE_error_data_4_CNN_with_STL_Decomposition_in48.csv', 'w') as f:
    for key, value in dict2MAPE.items():
        f.write('%s:%s\n' % (key, value))
with open('RMSE_error_data_4_CNN_with_STL_Decomposition_in48.csv', 'w') as f:
